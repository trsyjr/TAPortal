...
const NewsEvents = () => {
  ...
  return (
    <section className="relative pt-12 mt-12 px-4 md:px-10 lg:px-16 font-sans overflow-hidden">
      {/* Background Container */}
      <div
        className="absolute top-0 left-0 right-0 z-0 mx-auto" // Added mx-auto
        style={{
          height: "100%",
          width: "95%", // Adjusted to 95% so it's wider but still has "breathing room"
      ...
      <div className="relative z-10 max-w-[1600px] mx-auto">
        ...
        <div className="flex flex-col lg:flex-row items-center lg:items-start gap-10 xl:gap-20">
          ...
          <div className="w-full lg:w-[55%]">
            <div className="rounded-[2.5rem] overflow-hidden shadow-2xl border-[6px] border-white bg-white">
        ...
        {/* Brand Hashtag */}
        <p className="mt-20 mb-10 text-center text-[#2e3192] font-bold text-xl md:text-3xl lg:text-4xl tracking-tight">
