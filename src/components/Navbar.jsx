...
const Navbar = () => {
  ...
  const menuItems = [
    { name: "Home", path: "/" },
    {
      ...
      isDropdown: true,
      children: [
        { name: "Assessment, Certification, and Accreditation", path: "/cb-services", defaultTabId: 1 },
        { name: "Capability Building", path: "/cb-services", defaultTabId: 2 },
        { name: "Knowledge Management", path: "/cb-services", defaultTabId: 3 },
        { name: "TAAORSS", path: "/cb-services", defaultTabId: 4 },
      ],
    },
