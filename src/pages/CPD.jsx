      ...
      },
      {
        ...
        a: (
          <>
            ...
            <br />
            <br />
            You may indicate the general target geographic location or area where the training is intended to take place (e.g., "within Metro Manila" or "within Region VII").
          </>
        ),
      },
      {
...
const CPD = () => {
  ...
  // 2. Custom configuration passed cleanly into your imported component
  ...
  return (
    <div className="pt-20 font-sans relative">
      ...
      {/* 3. Replaced large boilerplate block with clean modular component */}
