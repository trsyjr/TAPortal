...
import Cliff from "../assets/Cliff-min.avif";
import Ten from "../assets/Ten-min.avif";
import Ana from "../assets/Ana-min.avif";
import Nori from "../assets/Nori-min.avif";
import Ritch from "../assets/Ritch-min.avif";
import Ros from "../assets/Ros-min.avif";
import Aljohn from "../assets/Aljohn-min.avif";
import Angel from "../assets/Angel-min.avif";
...
import Meann from "../assets/Meann-min.avif";
import Edd from "../assets/Edd-min.avif";
import Jo from "../assets/Jo-min.avif";
import Kleng from "../assets/Kleng-min.avif";
import Alma from "../assets/Alma.avif";
import Anggese from "../assets/Anggese.avif";
import Dan from "../assets/Dan.avif";
import Ella from "../assets/Ella.avif";
import Jane from "../assets/Jane.avif";
import Dale from "../assets/Dale.avif";
import Nate from "../assets/Nate.avif";
import Olan from "../assets/Olan.avif";
import Pim from "../assets/Pim.avif";
import Glenda from "../assets/Glenda.avif";
import Glo from "../assets/Glo.avif";
import Maan from "../assets/Maan.avif";
import Gelves from "../assets/Gelves.avif";
import Sky from "../assets/Sky.avif";
import Kath from "../assets/Kath.avif";
...
const About = () => {
 ...
 const focalPeople = [
  ...
  { title: "YAKAP BAYAN PROGRAM FOCAL", name: "Nikkita Lyka Gracia L. Ermino", email: "nlglermino@dswd.gov.ph", image: Nancy, category: "CBD" },
  ...
  { title: "KM STRATEGIST", name: "Ana T. Mendoza", email: "atmendoza@dswd.gov.ph", image: Ana, category: "KM" },
  ...
  { title: "LUZON B CLUSTER FOCAL", name: "Maria Annele B. Tio", email: "mabtio@dswd.gov.ph", image: "/assets/focal44.jpg", category: "TAAORSS" },
  ...
  }, [activeFilter, totalBaseWidth]);

  // Framer Motion continuous loop rendering configuration engine
  useAnimationFrame((time, deltaTime) => {
    if (isHoveredRef.current || isDraggingRef.current || totalBaseWidth === 0) return;

    // Fixed steady rate calculation (~65px tracking shift adjustments per unit interval)
    const movementStep = (65 * deltaTime) / 1000;
  ...
  const sections = [
    {
      ...
      content: (
        <>
          ...
          prior priorities, while remaining responsive to emerging sectoral needs.
          <br /><br />
          Through its professional learning and technical assistance
          innovations, the DSWD Academy supports the continuous strengthening
    ...
    },
    {
      ...
      content: (
        <>
          The Assessment, Certification, and Accreditation Division (ACAD) 
          is the DSWD Academy’s quality assurance engine, dedicated to safeguarding 
          and future-proofing standards of excellence in the Social Welfare and 
          Development sector. 
          In-charge with the certification of competencies for practitioners and 
          see the rigorous accreditation of learning service providers, trainers, 
          and training programs. One of its functions include managing the PRC-CPD 
          review process and processing applications to ensure all professional 
          development activities meet regulatory requirements for license renewal.
        </>
      ),
    },
    {
      ...
      content: (
        <>
          The Knowledge Management Division is responsible for strengthening the 
          Department’s capacity to generate, use, and share Social Welfare and 
          Development (SWD) knowledge internally and with partners, intermediaries, 
          and other stakeholders. It distills knowledge into relevant knowledge 
          products and services, policies, and strategies; develops technical 
          assistance and knowledge agendas; and establishes KM systems and 
          platforms for capturing, integrating, and managing capacity-building and 
          technical assistance initiatives. It also establishes and manages 
          Communities of Practice, oversees the DSWD Library and KM Portal, and 
          immonitors and evaluates KM-related technical assistance interventions 
    ...
    },
    {
      ...
      content: (
        <>
          Capability Building Division - Technical Assistance/ Advisory and Other Related Support Services (TAAORSS)
          <br /><br />
          The Technical/ Advisory Assistance and Other Related Support Services 
          Division is responsible for the management and operationalization of 
          the TA System for LGUs through the different OBS, Field Offices and 
          other stakeholders. lt shall lead the development and implementation 
          of efficient, results based, collaborative and coordinative TA 
          strategies for LGUs.
        </>
      ),
    },
    {
      ...
      isCustom: true,
      content: (
        <div className="w-full bg-[#1e2283] rounded-[2.5rem] p-6 md:p-10 text-white shadow-2xl relative overflow-hidden">
          ...
          <div className="flex flex-col lg:grid lg:grid-cols-12 gap-8 items-stretch w-full">
            ...
            <div className="col-span-12 lg:col-span-4 flex flex-col justify-between space-y-8 z-20 py-2 pr-2">
              <div>
               <div className="flex items-center gap-2 mb-3">
                ...
                <h3 className="text-4xl md:text-5xl font-bold tracking-tight leading-[1.1] select-none mb-6 mt-10">
                  Get In Touch <br />With <span className="italic font-serif" style={{ color: "#FFE066" }}>US</span>
                </h3>
              </div>
              ...
              <div className="space-y-3 pt-4 text-[0.7rem] font-medium tracking-wide text-white/80 select-none">
            ...
            <div className="col-span-12 lg:col-span-8 flex flex-col justify-center relative min-h-[460px] w-full overflow-hidden pl-0">
              ...
              {/* Conveyor Belt Framework Masking Container */}
              <div 
