...
const KnowledgeBank = () => {
  ...
  return (
    <div className="min-h-screen px-6 lg:px-20 py-16 lg:py-32 flex flex-col gap-12 lg:gap-16 items-center justify-center">
      ...
      {/* MAIN CONTENT */}
      <div className={`flex flex-col lg:flex-row gap-8 lg:gap-12 w-full max-w-[100rem]`}>
        {/* LEFT SIDE: Text */}
